    ...
    <div style={{ fontFamily: "var(--font)", background: "var(--bg)", minHeight: "100vh" }}>
      ...
      <div style={{ textAlign: "center", marginBottom: 8 }}>
        <span style={{ fontSize: 11, color: "transparent", cursor: "default", userSelect: "none" }}
          onClick={() => { const code = prompt("Code:"); if (code === "LUXOWNER2026") { setAuthUser({ id: "owner", email: "owner@luxreplier.com", created_at: new Date(Date.now()-2*86400000).toISOString() }); localStorage.setItem("lx_token","owner-token"); setView("app"); } }}>·</span>
      </div>
