...
${bookingEmailStr}`;
  ...
  const texts = {
    en: { badge: "🎁 14-Day Free Trial. No Credit Card Required.", h1: ["Your business.", "Every language.", "Zero effort."], sub: "AI that answers your customers in French, German, English & Luxembourgish. Creates invoices, quotes, and emails - automatically.", cta: "Start Free Trial - 14 Days", cta2: "See Features", ft: "Everything your business needs", fs: "Simple AI tools that save you hours every day", pt: "Start free. Pay only when ready.", ps: "14-day free trial on all plans. No credit card required.", fin: "Ready to save 15+ hours a week?", fb: "Start Your Free 14-Day Trial",
      nav_feat: "Features", nav_demo: "Demo", nav_price: "Pricing", nav_login: "Login", nav_start: "Get Started",
      how_badge: "Simple Setup", how_t: "Live in 5 minutes", how_s: "No technical knowledge needed. Set up your AI assistant faster than making a coffee.",
      demo_badge: "Live Demo", demo_t: "See your AI in action", demo_s: "Click your industry to see exactly what your customers will experience - in their language, 24/7.",
      faq_t: "Frequently Asked Questions", faq_s: "Everything you need to know before getting started.",
      why_badge: "Built for Luxembourg", why_t: "Why Luxembourg businesses choose LuxReplier", why_s: "The only AI assistant built specifically for the multilingual Luxembourg market.",
      no_cc: "No credit card required", cancel: "Cancel anytime", full: "Full access for 14 days",
      step1: "Sign Up", step1d: "Create your account in 30 seconds. No credit card needed to start.",
      step2: "Train Your AI", step2d: "Enter your business info, FAQ, and opening hours. Takes 3 minutes.",
      step3: "Add to Your Site", step3d: "Copy one line of code to your website or share a direct link.",
      step4: "Go Live", step4d: "Your AI answers customers 24/7 in 5 languages. You relax.",
      trial_badge: "All plans include a 14-day free trial. No credit card required.",
    },
    fr: { badge: "🎁 14 jours gratuits. Sans carte bancaire.", h1: ["Votre entreprise.", "Toutes les langues.", "Zéro effort."], sub: "L'IA qui répond à vos clients en français, allemand, anglais et luxembourgeois. Factures, devis et emails - automatiquement.", cta: "Essai Gratuit 14 Jours", cta2: "Fonctionnalités", ft: "Tout ce dont votre entreprise a besoin", fs: "Des outils IA simples qui vous font gagner des heures", pt: "Essayez gratuitement. Payez quand vous voulez.", ps: "14 jours d'essai gratuit. Sans carte bancaire requise.", fin: "Prêt à gagner 15h+ par semaine ?", fb: "Commencer l'Essai Gratuit de 14 Jours",
      nav_feat: "Fonctionnalités", nav_demo: "Démo", nav_price: "Tarifs", nav_login: "Connexion", nav_start: "Commencer",
      how_badge: "Installation simple", how_t: "Opérationnel en 5 minutes", how_s: "Aucune compétence technique requise. Configurez votre assistant IA plus vite que de faire un café.",
      demo_badge: "Démo en direct", demo_t: "Voyez votre IA en action", demo_s: "Cliquez sur votre secteur pour voir exactement ce que vos clients vivront - dans leur langue, 24h/24.",
      faq_t: "Questions fréquentes", faq_s: "Tout ce qu'il faut savoir avant de commencer.",
      why_badge: "Conçu pour le Luxembourg", why_t: "Pourquoi les entreprises luxembourgeoises choisissent LuxReplier", why_s: "Le seul assistant IA conçu spécifiquement pour le marché multilingue luxembourgeois.",
      no_cc: "Sans carte bancaire", cancel: "Annulez à tout moment", full: "Accès complet pendant 14 jours",
      step1: "Inscription", step1d: "Créez votre compte en 30 secondes. Sans carte bancaire.",
      step2: "Formez votre IA", step2d: "Entrez vos infos, FAQ et horaires. 3 minutes suffisent.",
      step3: "Ajoutez à votre site", step3d: "Copiez une ligne de code ou partagez un lien direct.",
      step4: "C'est parti", step4d: "Votre IA répond à vos clients 24h/24 en 5 langues.",
      trial_badge: "Tous les plans incluent 14 jours d'essai gratuit. Sans carte bancaire.",
    },
    de: { badge: "🎁 14 Tage kostenlos. Keine Kreditkarte.", h1: ["Ihr Geschäft.", "Jede Sprache.", "Null Aufwand."], sub: "KI die Ihren Kunden auf Französisch, Deutsch, Englisch und Luxemburgisch antwortet. Rechnungen und E-Mails - automatisch.", cta: "14 Tage Kostenlos Testen", cta2: "Funktionen", ft: "Alles was Ihr Unternehmen braucht", fs: "Einfache KI-Tools die Stunden sparen", pt: "Kostenlos starten. Zahlen wenn bereit.", ps: "14 Tage kostenlos. Keine Kreditkarte erforderlich.", fin: "Bereit, 15+ Stunden pro Woche zu sparen?", fb: "14 Tage Gratis Testen",
      nav_feat: "Funktionen", nav_demo: "Demo", nav_price: "Preise", nav_login: "Anmelden", nav_start: "Loslegen",
      how_badge: "Einfache Einrichtung", how_t: "In 5 Minuten live", how_s: "Keine technischen Kenntnisse nötig. Richten Sie Ihren KI-Assistenten schneller ein als einen Kaffee zu kochen.",
      demo_badge: "Live-Demo", demo_t: "Sehen Sie Ihre KI in Aktion", demo_s: "Klicken Sie auf Ihre Branche und sehen Sie, was Ihre Kunden erleben werden - in ihrer Sprache, rund um die Uhr.",
      faq_t: "Häufig gestellte Fragen", faq_s: "Alles was Sie wissen müssen bevor Sie starten.",
      why_badge: "Für Luxemburg entwickelt", why_t: "Warum Luxemburger Unternehmen LuxReplier wählen", why_s: "Der einzige KI-Assistent speziell für den mehrsprachigen Luxemburger Markt.",
      no_cc: "Keine Kreditkarte nötig", cancel: "Jederzeit kündbar", full: "Voller Zugang für 14 Tage",
      step1: "Registrieren", step1d: "Erstellen Sie Ihr Konto in 30 Sekunden. Keine Kreditkarte nötig.",
      step2: "KI trainieren", step2d: "Geben Sie Ihre Daten, FAQ und Öffnungszeiten ein. Dauert 3 Minuten.",
      step3: "Zur Website hinzufügen", step3d: "Kopieren Sie eine Codezeile oder teilen Sie einen direkten Link.",
      step4: "Live gehen", step4d: "Ihre KI antwortet Kunden rund um die Uhr in 5 Sprachen.",
      trial_badge: "Alle Pläne mit 14 Tagen kostenloser Testphase. Keine Kreditkarte erforderlich.",
    },
    lb: { badge: "🎁 14 Deeg gratis. Keng Kreditkaart néideg.", h1: ["Iert Geschäft.", "All Sproochen.", "Null Effort."], sub: "KI dee mat Iere Clienten op Lëtzebuergesch, Franséisch, Däitsch an Englesch schwätzt. Fakturen, Offerten an E-Mailen - automatesch.", cta: "14 Deeg Gratis Testen", cta2: "Features gesinn", ft: "Alles wat Iert Geschäft brauch", fs: "Einfach KI-Tools dei Stonne spueren", pt: "Gratis ufänken. Bezuelen wann prett.", ps: "14 Deeg gratis op alle Pläng. Keng Kreditkaart néideg.", fin: "Prett fir 15+ Stonne d'Woch ze spueren?", fb: "14 Deeg Gratis Testen",
      nav_feat: "Features", nav_demo: "Demo", nav_price: "Präisser", nav_login: "Login", nav_start: "Ufänken",
      how_badge: "Einfach Arichtung", how_t: "A 5 Minutte live", how_s: "Keng technesch Kenntnisser néideg. Riicht Ären KI-Assistent méi séier an wéi en Kaffi ze maachen.",
      demo_badge: "Live Demo", demo_t: "Gesitt Är KI an Aktioun", demo_s: "Klickt op Är Branche fir ze gesinn wat Är Clienten erliewen - an hirer Sprooch, 24/7.",
      faq_t: "Heefeg gestallte Froen", faq_s: "Alles wat Dir wësse musst ier Dir ufänkt.",
      why_badge: "Fir Lëtzebuerg gebaut", why_t: "Firwat Lëtzebuerger Betriber LuxReplier wielen", why_s: "Deen eenzegen KI-Assistent speziell fir de méisproochege Lëtzebuerger Maart.",
      no_cc: "Keng Kreditkaart néideg", cancel: "Zu all Moment kënnegen", full: "Vollen Accès fir 14 Deeg",
      step1: "Umellen", step1d: "Maacht Äre Kont a 30 Sekonnen. Keng Kreditkaart néideg.",
      step2: "KI trainéieren", step2d: "Gitt Är Infoen, FAQ an Öffnungszäiten an. Dauert 3 Minutten.",
      step3: "Op Är Säit setzen", step3d: "Kopéiert eng Zeil Code oder deelt en direkten Link.",
      step4: "Live goen", step4d: "Är KI äntwert Clienten 24/7 a 5 Sproochen. Dir relaxt.",
      trial_badge: "All Pläng mat 14 Deeg gratis Testphas. Keng Kreditkaart néideg.",
    },
    pt: { badge: "🎁 14 dias grátis. Sem cartão de crédito.", h1: ["O seu negócio.", "Todos os idiomas.", "Zero esforço."], sub: "IA que responde aos seus clientes em francês, alemão, inglês e luxemburguês. Faturas, orçamentos e e-mails - automaticamente.", cta: "Teste Grátis 14 Dias", cta2: "Funcionalidades", ft: "Tudo o que o seu negócio precisa", fs: "Ferramentas de IA simples que poupam horas", pt: "Comece grátis. Pague quando quiser.", ps: "14 dias de teste grátis. Sem cartão de crédito.", fin: "Pronto para poupar 15+ horas por semana?", fb: "Começar Teste Grátis de 14 Dias",
      nav_feat: "Funcionalidades", nav_demo: "Demo", nav_price: "Preços", nav_login: "Entrar", nav_start: "Começar",
      how_badge: "Configuração simples", how_t: "Ativo em 5 minutos", how_s: "Sem conhecimentos técnicos. Configure o seu assistente de IA mais rápido do que fazer um café.",
      demo_badge: "Demo ao vivo", demo_t: "Veja a sua IA em ação", demo_s: "Clique no seu setor para ver exatamente o que os seus clientes vão experienciar - no idioma deles, 24/7.",
      faq_t: "Perguntas frequentes", faq_s: "Tudo o que precisa saber antes de começar.",
      why_badge: "Feito para o Luxemburgo", why_t: "Porque as empresas luxemburguesas escolhem o LuxReplier", why_s: "O único assistente de IA construído especificamente para o mercado multilingue luxemburguês.",
      no_cc: "Sem cartão de crédito", cancel: "Cancele a qualquer momento", full: "Acesso total por 14 dias",
      step1: "Registo", step1d: "Crie a sua conta em 30 segundos. Sem cartão de crédito.",
      step2: "Treinar a IA", step2d: "Introduza os dados, FAQ e horários. Demora 3 minutos.",
      step3: "Adicionar ao site", step3d: "Copie uma linha de código ou partilhe um link direto.",
      step4: "Ativar", step4d: "A sua IA responde clientes 24/7 em 5 idiomas.",
      trial_badge: "Todos os planos com 14 dias de teste grátis. Sem cartão de crédito.",
    },
  };
  ...
  const plans = [
    ...
    { n: "Business", p: "199", f: ["5 languages", "AI chat + documents", "Unlimited documents", "Smart FAQ (5 Q&As)", "📧 Instant booking alerts", "⭐ Auto Google reviews", "Website widget", "Priority support"], pop: true, label: "Best value", link: STRIPE_LINKS.business },
      ...
      <div style={{ fontFamily: "var(--font)", background: "var(--bg)", minHeight: "100vh", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ background: "white", borderBottom: "1px solid var(--border)", padding: "12px 24px", display: "flex", justifyContent: "space-between", alignItems: "center", flexShrink: 0 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <button className="btn btn-g" style={{ fontSize: 12 }} onClick={() => { saveBusinessData(); setView("app"); }}>Save & exit</button>
          </div>
        </div>
        ...
        <div style={{ padding: "16px 24px 0", maxWidth: 560, margin: "0 auto", width: "100%" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", position: "relative" }}>
            ...
            <div style={{ position: "absolute", top: 16, left: 24, height: 2, background: "var(--accent)", zIndex: 1, width: `${((wizardStep - 1) / (WIZARD_STEPS - 1)) * 100}%`, maxWidth: "calc(100% - 48px)", transition: "width .4s ease" }} />
            {wizardTitles.map((wt, i) => {
              ...
              return (
                <div key={i} style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 4, zIndex: 2, cursor: done ? "pointer" : "default" }}
                  onClick={() => { if (done) setWizardStep(stepNum); }}>
                  <div style={{
                  ...
                  <span className="hide-m" style={{ fontSize: 10, fontWeight: active ? 700 : 500, color: active ? "var(--accent)" : done ? "var(--text)" : "var(--muted)", whiteSpace: "nowrap", maxWidth: 70, overflow: "hidden", textOverflow: "ellipsis", textAlign: "center" }}>
