      ...
      <div style={{ maxWidth: 420, width: "100%" }}>
        ...
        <div className="card fu fu1" style={{ padding: 28 }}>
          <div style={{ marginBottom: 18 }}>
            ...
            <input type="password" placeholder="At least 8 characters" value={resetNewPass}
          ...
          <div style={{ marginBottom: 24 }}>
            ...
            <input type="password" placeholder="Re-enter your new password" value={resetConfirmPass}
            ...
            <div className="fu">
              ...
              <div className="card" style={{ padding: 28, marginBottom: 16 }}>
                ...
                <div style={{ marginBottom: 16 }}>
                  ...
                  <input type="password" placeholder="Re-enter your password" value={confirmPass} onChange={e => setConfirmPass(e.target.value)} style={{ fontSize: 15 }} />
                ...
                {!showChangePass ? (
                  ...
                  <div style={{ padding: 16, background: "#0D1220", borderRadius: 10, border: "1px solid #2A3A5C" }}>
                    <div style={{ marginBottom: 10 }}>
                      ...
                      <input type="password" placeholder="At least 8 characters" value={newPass} onChange={e => setNewPass(e.target.value)}
                        style={{ background: "#1A2744", border: "1px solid #2A3A5C", color: "#F0F4FF", borderRadius: 8, padding: "10px 12px", width: "100%", fontSize: 13, fontFamily: "var(--font)", outline: "none" }} />
                    </div>
                    <div style={{ marginBottom: 12 }}>
                      <label style={{ fontSize: 12, fontWeight: 600, color: "#8B9CC8", display: "block", marginBottom: 4 }}>Confirm New Password</label>
                      <input type="password" placeholder="Re-enter new password" value={confirmNewPass} onChange={e => setConfirmNewPass(e.target.value)}
                        style={{ background: "#1A2744", border: "1px solid #2A3A5C", color: "#F0F4FF", borderRadius: 8, padding: "10px 12px", width: "100%", fontSize: 13, fontFamily: "var(--font)", outline: "none" }} />
