...
.btn-p:disabled{opacity:.5;cursor:not-allowed}
  ...
  .anim-right{animation:fadeRight .7s ease .25s both}
    ...
    <div style={{ fontFamily: "var(--font)", background: "var(--bg)", minHeight: "100vh" }}>
      ...
      <section style={{ maxWidth: 1060, margin: "0 auto", padding: "56px 24px 40px" }}>
        <div className="m-stack" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "center" }}>
          ...
          {/* Left: text */}
          <div className="anim-left" style={{ textAlign: "left" }}>
          ...
          <div className="hide-m anim-right anim-float" style={{ display: "flex", justifyContent: "center" }}>
      ...
      <section className="fu fu4" style={{ maxWidth: 680, margin: "0 auto 56px", padding: "0 24px" }}>
        <div className="m-2col" style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 10 }}>
          {[{ n: "5", l: (tx.stats||["Languages","Always On","Days Free","Setup: 5min"])[0] }, { n: "24/7", l: (tx.stats||["Languages","Always On","Days Free","Setup: 5min"])[1] }, { n: "14", l: (tx.stats||["Languages","Always On","Days Free","Setup: 5min"])[2] }, { n: "5 min", l: (tx.stats||["Languages","Always On","Days Free","Setup: 5min"])[3] }].map((s, i) => (
