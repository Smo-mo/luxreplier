  ...
  if (view === "home") return (
    <div style={{ fontFamily: "var(--font)", background: "var(--bg)", minHeight: "100vh" }}>
      ...
      <section id="showcase" style={{ maxWidth: 900, margin: "0 auto", padding: "0 24px 72px" }}>
        ...
        {(() => {
          // Helper: dynamic next weekday in German (avoids hardcoded wrong dates)
          const getNextWeekdayDE = (dayIndex = 3) => {
          ...
          const demos = {
            restaurant: {
              ...
              msgs: [
                ...
                { role: "ai", text: "Bonsoir, bienvenue chez notre restaurant. Nous avons une table disponible ce soir à 20h pour 4 personnes. Puis-je réserver à votre nom?" },
                { role: "user", text: "Au nom de Dupont, 621 123 456" },
                { role: "ai", text: "Votre table pour 4 personnes est confirmée ce soir à 20h00 au nom de Dupont. Nous vous attendons avec plaisir. À ce soir." },
              ]
            },
            realestate: {
              lang: "🇬🇧 English",
              ...
              msgs: [
                ...
                { role: "ai", text: "We currently have three apartments in Kirchberg within your budget:\n1) 2-bed, 75m\u00B2, Rue Erasme \u2013 1,850/month\n2) 2-bed, 82m\u00B2, Avenue JF Kennedy \u2013 1,950/month\n3) 2-bed with terrace, 90m\u00B2, Rue Alphonse Weicker \u2013 1,990/month\nWould you like to arrange a viewing for any of these?" },
                { role: "user", text: "The third one sounds great, can I visit this Saturday?" },
                { role: "ai", text: "I will arrange a viewing of the Rue Alphonse Weicker apartment for Saturday. Could you share your preferred time?" },
              ]
            },
            salon: {
              lang: "🇱🇺 Lëtzebuergesch",
              ...
              msgs: [
                ...
                { role: "ai", text: "Moien, willkomm bei eisem Salon. Eng komplett Faarf mat Coupe läit tëschent 85\u20AC an 120\u20AC, jee no Haarlängt. Mir schaffen exklusiv mat L\u2019Oréal Professionnel. Wëllt Dir en Termin maachen?" },
            ...
            dental: {
              ...
              msgs: [
                ...
                { role: "ai", text: "Guten Tag. Ja, wir nehmen derzeit neue Patienten auf. Eine Standardkontrolle kostet 65\u20AC und wird von der CNS teilweise erstattet. Wir akzeptieren ebenfalls private Zusatzversicherungen. Darf ich Ihnen einen Termin vorschlagen?" },
                { role: "user", text: "Ja, möglichst bald bitte." },
                { role: "ai", text: `Der nächste verfügbare Termin ist ${getNextWeekdayDE(3)} um 14:30 Uhr. Passt Ihnen das? Falls ja, bräuchte ich Ihren vollständigen Namen für die Anmeldung.` },
              ]
            },
            accounting: {
              lang: "🇫🇷 Français",
              ...
              msgs: [
                ...
                { role: "ai", text: "Bonjour. Pour un indépendant, notre forfait déclaration fiscale est de 450\u20AC HT. Celui-ci inclut la préparation complète, l\u2019optimisation fiscale et le dépôt auprès de l\u2019ACD. Nous proposons également une première consultation gratuite de 30 minutes." },
                { role: "user", text: "Oui, la consultation gratuite m'intéresse." },
                { role: "ai", text: "Avec plaisir. Nous avons des créneaux disponibles cette semaine. Quel jour vous conviendrait le mieux?" },
              ]
            },
            retail: {
              lang: "🇬🇧 English",
              ...
              msgs: [
                ...
                { role: "ai", text: "Yes, we have the Nike Air Max 90 in size 43 in two colours:\n\u2013 White/Grey: 139.95 EUR (in stock)\n\u2013 Black/Red: 144.95 EUR (in stock)\nWe can reserve a pair for you for 48 hours at no charge." },
            ...
            plumber: {
              ...
              msgs: [
                ...
                { role: "ai", text: "Mir kënnen direkt hëllefen. Eisen Notdéngscht ass 7 Deeg d\u2019Woch disponibel. En Techniker ka bannent 2 Stonnen bei Iech sinn. D\u2019Deplacement kascht 85\u20AC, doropshin gëtt d\u2019Aarbecht no Opwand ofgerechent. Wéi ass Är Adress?" },
                { role: "user", text: "14 Rue de Hollerich, Lëtzebuerg-Stad" },
                { role: "ai", text: "En Techniker ass ënnerwee op 14 Rue de Hollerich. Kéint Dir mir Är Telefonsnummer ginn? Den Techniker rifft Iech un wann en do ass." },
              ]
            },
          };
