        ...
        <div className="card fu fu1" style={{ padding: 28 }}>
          ...
          {step === 2 && (
            <div>
              ...
              <button className="btn btn-p" style={{ width: "100%", padding: 14, fontSize: 15 }} disabled={signup.card.replace(/\s/g, "").length < 16 && signup.ownerCode !== "LUXOWNER2026"} onClick={() => { if (signup.ownerCode === "LUXOWNER2026") { setUserPlan("premium"); } setView("setup"); }}>Start Free Trial →</button>
