...
8. Luxembourgish: If someone writes in Luxembourgish, reply in Luxembourgish.${reviewStr}${bookingEmailStr}`;
  ...
  const doOwnerLogin = () => {
    ...
    if (entered === "LUXOWNER2026") {
      setAuthUser({ id: "owner", email: "owner@luxreplier.com", created_at: new Date(Date.now() - 2 * 86400000).toISOString() });
      localStorage.setItem("lx_token", "owner-token");
      setView("app");
    }
  };
  ...
  if (view === "home") return (
    <div style={{ fontFamily: "var(--font)", background: "var(--bg)", minHeight: "100vh" }}>
      ...
      <div style={{ textAlign: "center", marginBottom: 8 }}>
        <span style={{ fontSize: 11, color: "transparent", userSelect: "none" }} onClick={doOwnerLogin}>·</span>
      </div>
